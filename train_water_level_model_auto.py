...
# モデルクラスのインポート
from water_level_prediction_model_v2 import WaterLevelPredictorV2 as WaterLevelPredictor

# train_water_level_model.pyから関数をコピー
...
def main(do_cv=False, do_online_demo=False):
    """
    メイン処理
    ...
    # オンライン学習のデモ
    if do_online_demo and len(X_test) >= 100:
        print("\n=== オンライン学習デモ ===")
        print("最新100サンプルでオンライン更新を実行...")
        X_online = X_test[-100:]
        y_online = y_test[-100:]
...
if __name__ == "__main__":
    # 自動実行：クロスバリデーションなし、オンライン学習デモなし
    main(do_cv=False, do_online_demo=False)