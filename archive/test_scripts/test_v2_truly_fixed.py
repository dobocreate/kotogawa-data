...
from discharge_prediction_model_v2_truly_fixed import DischargePredictionModelV2
...
def test_fixed_model():
    ...
    # 過去の降雨履歴も確認
    print("\n過去1時間の降雨履歴:")
    past_1h = historical_data.iloc[-7:]
    for _, row in past_1h.iterrows():
    ...
    filename = f'v2_truly_fixed_test_{timestamp}.png'
    ...
    # モデルを保存
    model.save_model(f'discharge_prediction_model_v2_truly_fixed_{timestamp}.pkl')
    print(f"真の修正版モデルを保存: discharge_prediction_model_v2_truly_fixed_{timestamp}.pkl")
